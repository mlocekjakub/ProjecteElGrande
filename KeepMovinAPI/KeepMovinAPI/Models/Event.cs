...
namespace KeepMovinAPI.Models
{
    public class Event
    {
        ...
        [Column("organizer_user_id")] public int OrganizerUserId { get; set; }

        [Column("sport_id")] public int SportId { get; set; }

        [Column("experience_level")] public string ExperienceLevel { get; set; }

        [Column("event_info")] public string EventInfo { get; set; }
